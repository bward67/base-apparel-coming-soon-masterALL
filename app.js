...
form.addEventListener("submit", (e) => {
  ...
  if (emailValue === "") {
    ...
    form.innerHTML = `<h1 style="text-align:center;color:green">Thank you!</h1><p style="text-align:center;color:green">You have been successfully added to our mailing list.</p>`;
  }
});
